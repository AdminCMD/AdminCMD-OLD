...
final public class InvisibleWorker {
        ...
        /**
         * Stop the task that try to make the player invisible when he
         * disconnect
         *
         * @param toReappear
         */
         ...
         *
         * @param toVanish player to vanish
         * @param onJoinEvent if it's done on join event.
         */
         ...
         *
         * @param newPlayer new connected player.
         */
