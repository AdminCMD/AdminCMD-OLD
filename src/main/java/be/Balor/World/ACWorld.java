...
public abstract class ACWorld {
         ...
         *
         * @param name name of the wanted world
         * @return the ACWorld
         * @throws WorldNotLoaded if the world is not loaded in bukkit or don't
         * exist
         */
         ...
         * Get the wanted world
         *
         * @param world loaded bukkit world
         * @return the ACWorld
         */
         ...
         * @param name name of the warp
         * @param loc location of the warp
         * @param perm ...........permission needed to use this warp
         */
         ...
         * @throws WorldNotLoaded if the location's world is not loaded
         ...
         *
         * @param info key of the information
         * @param value information to set
         */
         ...
         * @param limit limit for that mob
         */
         ...
         *
         * @param group name of the group. If null, return the location of the
         * default spawn.
         * @return location of the spawn point. If no location has been set for
         * the group, return the default spawn.
         */
