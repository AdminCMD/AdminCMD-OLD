...
public enum Type {
        ...
        /**
         * Attempts to match the Type with the given name. This is a match
         * lookup; names will be converted to uppercase, then stripped of
         * special characters in an attempt to format it like the enum
         *
