...
class ClassExactMatcher extends AbstractFuzzyMatcher<Class<?>> {
        ...
        enum Options {
                ...
                MATCH_EXACT,
                /**
                 * A match if the input class is a superclass of the matcher
                 * class, or the same class.
                 */
                MATCH_SUPER,
                /**
                 * A match if the input class is a derived class of the matcher
                 * class, or the same class.
                 */
                MATCH_DERIVED
        }
         ...
         * <p>
         * If the matcher is NULL, the result will only be TRUE if we're not
         * matching exactly.
         *
         * @param input - the input class defined in the source file.
         * @param parent - the container that holds a reference to this class.
         * @return TRUE if input matches according to the rules in
         * {@link #getOptions()}, FALSE otherwise.
         */
        @Override
         ...
         * <p>
         * Object is represented as one. All interfaces are one, unless they're
         * derived.
         *
