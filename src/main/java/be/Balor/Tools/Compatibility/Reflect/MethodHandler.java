...
public class MethodHandler {
         ...
         *
         * @param clazz - given class, source of the method
         * @param name - name of the method
         * @param parameterTypes - types of the args of the method
         */
        ...
        /**
         * Invoke the enclosed method on the given object with the given
         * arguments
         *
