...
public abstract class AbstractFuzzyMatcher<T> implements Comparable<AbstractFuzzyMatcher<T>> {
         ...
         * @param parent - the parent container, or NULL if this value is the
         * root.
         ...
         * higher round number.
         * <p>
         * By convention, this round number should be negative, except for zero
         * in the case of a matcher that accepts any value. A good
         * implementation should return the inverted tree depth (class hierachy)
         * of the least specified type used in the matching. Thus
         * {@link Integer} will have a lower round number than {@link Number}.
         *
         * @return A number (positive or negative) that is used to order
         * matchers.
         */
        ...
        /**
         * Combine n round numbers by taking the highest non-zero number, or
         * return zero.
         *
        ...
        /**
         * Create a fuzzy matcher that returns the opposite result of the
         * current matcher.
         *
