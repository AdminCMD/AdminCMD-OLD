...
public class MethodUtils {
         ...
         * @param parameterTypes - parameter type of the method (Class<?>)
         * @return the wanted method if found
         * @throws RuntimeException if the method don't exist.
         */
         ...
         *
         * @param clazz - given class
         * @param contract - contract containing the information about the
         * method
         * @return the wanted method if found
         * @throws RuntimeException if the method don't exist.
         */
        ...
        /**
         * Invoke the method with the given argument on the given object. Works
         * also for private method.
         *
         * @param obj - given object
         * @param method - given method
         * @param args - given arguments
         * @return the result of the method.
         * @throws RuntimeException if there is a problem while invoking the
         * method.
         */
