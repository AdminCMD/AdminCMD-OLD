...
public class FuzzyMatchers {
        ...
        /**
         * Construct a class matcher that matches any of the given classes
         * exactly.
         *
        ...
        /**
         * Construct a class matcher that matches super types of the given
         * class.
         *
         * @param matcher - the matching type must be a super class of this
         * type.
         * @return A new class mathcher.
         */
        ...
        /**
         * Construct a class matcher that matches derived types of the given
         * class.
         *
         * @param matcher - the matching type must be a derived class of this
         * type.
         * @return A new class mathcher.
         */
         ...
         * <p>
         * Note that two patterns may be functionally the same, but nevertheless
         * be different.
         *
         * @param a - the first pattern.
         * @param b - the second pattern.
         * @return TRUE if they are compiled from the same pattern, FALSE
         * otherwise.
         */
