...
public abstract class AbstractFuzzyMember<T extends Member> extends AbstractFuzzyMatcher<T> {
        ...
        public static abstract class Builder<T extends AbstractFuzzyMember<?>> {
                ...
                /**
                 * Add a given bit-field of required modifiers for every
                 * matching member.
                 *
                ...
                /**
                 * Add a given bit-field of modifers that will skip or ignore
                 * members.
                 *
                ...
                /**
                 * Set the regular expression pattern that matches a members
                 * name.
                 *
                ...
                /**
                 * Set the exact name of the member we are matching. <p< This
                 * will overwrite the regular expression rule.
                 *
                 ...
                 *
                 * @param declaringClass - the declaring class of any matching
                 * member.
                 * @return This builder, for chaining.
                 */
                ...
                /**
                 * Require that a member is defined by this exact class, or any
                 * super class.
                 *
                ...
                /**
                 * Require that a member is defined by a class that matches the
                 * given matcher.
                 *
                 ...
                 * <p>
                 * Builders should call
                 * {@link AbstractFuzzyMember#prepareBuild()} when constructing
                 * new objects.
                 *
         ...
         * {@link java.lang.reflect.Modifier Modifier} that is required for the
         * member to match.
         *
        ...
        /**
         * Retrieve a bit field of every
         * {@link java.lang.reflect.Modifier Modifier} that must not be present
         * for the member to match.
         *
        ...
        /**
         * Retrieve the regular expression pattern that is used to match the
         * name of a member.
         *
