...
public abstract class MethodInfo implements GenericDeclaration, Member {
        ...
        /**
         * Construct a list of method infos from a given collection of
         * constructors.
         *
        ...
        /**
         * Returns a string describing this method or constructor, including
         * type parameters.
         *
         ...
         * exceptions declared to be thrown by the underlying method or
         ...
         * types, in declaration order, of the method or constructor represented
         * by this MethodInfo object.
         *
