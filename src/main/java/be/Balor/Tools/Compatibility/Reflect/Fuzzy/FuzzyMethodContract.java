...
public class FuzzyMethodContract extends AbstractFuzzyMember<MethodInfo> {
        ...
        private static class ParameterClassMatcher extends AbstractFuzzyMatcher<Class<?>[]> {
                 ...
                 *
                 * @param typeMatcher - class type matcher.
                 * @param indexMatch - parameter index to match, or NULL for
                 * anything.
                 */
                 ...
                 * @param parent - the container (member) that holds a reference
                 * to this parameter.
                 * @param params - the type of each parameter.
                 * @return TRUE if this matcher matches any of the given
        ...
        public static class Builder extends AbstractFuzzyMember.Builder<FuzzyMethodContract> {
                ...
                /**
                 * Add a new required parameter whose type must be a superclass
                 * of the given type.
                 * <p>
                 * If a method parameter is of type Number, then any derived
                 * class here (Integer, Long, etc.) will match it.
                 *
                 * @param type - a type or less derived type of the matching
                 * parameter.
                 * @return This builder, for chaining.
                 */
                ...
                /**
                 * Add a new required parameter whose type must be a derived
                 * class of the given class.
                 * <p>
                 * If the method parameter has the type Integer, then the class
                 * Number here will match it.
                 *
                 * @param type - a type or more derived type of the matching
                 * parameter.
                 * @return This builder, for chaining.
                 */
                ...
                /**
                 * Add a new required parameter whose type must match the given
                 * class matcher.
                 *
                ...
                /**
                 * Add a new required parameter by type and position for any
                 * matching method.
                 *
                 * @param type - the exact type this parameter must match.
                 ...
                 * of the given type.
                 * <p>
                 * If a parameter is of type Number, any derived class (Integer,
                 * Long, etc.) will match it.
                 *
                 * @param type - a type or derived type of the matching
                 * parameter.
                 * @param index - the expected position in the parameter list.
                 * @return This builder, for chaining.
                 */
                ...
                /**
                 * Set the expected super class of the return type for every
                 * matching method.
                 *
                ...
                /**
                 * Set a matcher that must match the return type of a matching
                 * method.
                 *
                ...
                /**
                 * Add a throwable exception that must match the given type
                 * exactly.
                 *
                ...
                /**
                 * Add a throwable exception that must match the given type or
                 * be derived.
                 *
                 * @param type - exception type.
                 * @return This builder, for chaining.
        ...
        /**
         * Retrieve an immutable list of every parameter matcher for this
         * method.
         *
        ...
        /**
         * Retrieve an immutable list of every exception matcher for this
         * method.
         *
