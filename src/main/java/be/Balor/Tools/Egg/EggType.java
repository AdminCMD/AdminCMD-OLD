...
public abstract class EggType<T> implements Serializable {
        ...
        /**
         * This function will be executed by the listener when the player have
         * the power Egg with this EggType
         *
         * @param event triggered when the player throw an egg.
         */
         ...
         *
         * @param sender Player that send the command.
         * @param args argument that will be used to set the EggType.
         *
         * @throws ProcessingArgsException when there is a problem in the
         * arguments
         */
         ...
         * @param player
         * @return
         * @throws DontHaveThePermissionException when the player don't have the
         * permission, with the message to display to the user
         */
        ...
        /**
         * Will create the Egg that can be assigned later to the player. This
         * method check if the player has the permission to use that egg and if
         * the arguments of the command are right.
         *
         * @param player That execute the EggSpawn command.
         * @param args Provided by the EggSpawn command.
         * @return an EggType of the chosen type if every test is passed.
         * @throws ProcessingArgsException if there is a problem while
         * processing the arguments, like a Parameter missing, or some other
         * error.
         * @throws DontHaveThePermissionException if the player don't have the
         * permission to use that egg
         */
