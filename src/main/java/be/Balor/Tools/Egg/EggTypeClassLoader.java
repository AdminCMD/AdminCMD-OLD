...
public class EggTypeClassLoader extends ClassLoader {
        ...
        /**
         * Add a Package that containing the EggType class. The Class must have
         * a name that finish by Egg.
         *
         * @param packageName
         */
         ...
         * http://snippets.dzone.com/posts/show/4831 and extended to support use
         * of JAR files
         *
        ...
        /**
         * Recursive method used to find all classes in a given path (directory
         * or zip file url). Directories are searched recursively. (zip files
         * are Adapted from http://snippets.dzone.com/posts/show/4831 and
