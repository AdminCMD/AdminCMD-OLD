 ...
 *
 * @param permission represent the permission of the EggType.
 * @param permissionParent represent to which permission the permission will be
 * the child. Can be empty if you don't want any parent.
 *
