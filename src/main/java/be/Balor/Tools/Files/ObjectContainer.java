...
public class ObjectContainer {
        ...
        /**
         * Gets a string at a location. This will either return an String or
        ...
        /**
         * Gets a TpRequest at a location. This will either return a TpRequest
         * or null, with null meaning that no configuration value exists at that
         * location. If the object at the particular location is not actually a
         ...
         * actually a integer, the default value will be returned. However,
         ...
         * default value. If the object at the particular location is not
        ...
        /**
         * Gets a boolean at a location. This will either return an boolean or
         * the default value. If the object at the particular location is not
        ...
        /**
         * Gets a long at a location. This will either return an long or the
         * default value. If the object at the particular location is not
         * actually a long, the default value will be returned.
         *
         * @param def default value
         * @return boolean or default
         */
         ...
         * There will be no null slots. If the list is not defined, the default
         * will be returned. 'null' can be passed for the default and an empty
         * list will be returned instead. If an item in the list is not a
         * string, it will be converted to a string. The node must be an actual
         * list and not just a string.
         *
         ...
         * There will be no null slots. If the list is not defined, the default
         * will be returned. 'null' can be passed for the default and an empty
         * list will be returned instead. The node must be an actual list and
         * not just an integer.
         *
         * @param def default value or null for an empty list as default
