...
class HelpList {
        ...
        public HelpList(final Plugin plugin) throws IllegalArgumentException {
                ...
                try {
                        for (final Entry<String, Map<String, Object>> k : cmds.entrySet()) {
                                ...
                                final String desc = value.get("description") != null ? value.get("description").toString() : "";
        ...
        /**
         * Get a list of the string to display for the wanted page, and the
         * given user
         *
         * @param page int the wanted page
         * @param sender CommandSender the sender of the command
         * @param detailed If true the detailed description will be displayed if
         * one exists
         * @return
         */
        ...
        /**
         * Get the command help of the wanted command by matching it in the list
         * of avaible commands.
         *
         * @param cmd command to search
         * @param sender sender of the command (used for checking the
         * permission)
         * @param detailed If true the detailed description will be displayed if
         * one exists
         * @return the chat String to display to the user, <b>null</b> if not
         * found
         */
