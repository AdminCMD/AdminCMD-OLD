...
public final class Immunity {
         ...
         * other player
         *
         * @param sender the one who want to do the command
         * @param target the target of the command
         * @return true if the sender have the right to execute the command,
         * else false.
         */
        public static boolean checkImmunity(final CommandSender sender,
                final Player target) {
         ...
         *
         * @param sender the one who want to do the command
         * @param args containing the name of the target
         * @param index index of the target's name in the argument
         * @return true if the sender have the right to execute the command,
         * else false with displaying an error message to the sender.
         */
        public static boolean checkImmunity(final CommandSender sender,
