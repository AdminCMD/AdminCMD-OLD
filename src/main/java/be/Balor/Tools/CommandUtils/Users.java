...
public final class Users {
        ...
        /**
         * Get the ACPlayer, useful when working with only the AC user
         * informations
         *
         * @param sender sender of the command
         * @param args args in the command
         * @param permNode permission node to execute the command
        ...
        /**
         * Get the ACPlayer, useful when working with only the AC user
         * informations using the -P parameter.
         *
         * @param sender sender of the command
         * @param args args in the command
         * @param permNode permission node to execute the command
        ...
        /**
         * Get the user using the -P param as indicating the userName and check
         * who launched the command.
         *
         * @param sender sender of the command
         * @param args argument of the command
         * @param permNode permission to run the command
         * @return target player if found
         * @throws PlayerNotFound if the target player is not found
         ...
         * @param args argument of the command
         * @param permNode permission to run the command
         * @param errorMsg send or not the exception about an unfound player
         * @return target player if found
         * @throws PlayerNotFound if the target player is not found
         * @throws PermissionException if the player don't have the permission
         */
        ...
        /**
         * Get the player list ordered by group and alphabetically for the
         * sender
         *
         * @param sender sender of the command
