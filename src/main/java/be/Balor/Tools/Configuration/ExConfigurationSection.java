...
public interface ExConfigurationSection extends ConfigurationSection {
        ...
        /**
         * Create an entry in the {@link ExConfigurationSection} if it not
         * existing else return the existing one.
         *
         * @param path Path to create/get the entry at.
         * @return false if the path already exists, true if it's not set.
         */
        public boolean add(String path, Object value);

        /**
         * Create a {@link ExConfigurationSection} if it not existing else
         * return the existing one.
         *
         * @param path Path to create/get the section at.
         ...
         *
         * @param path Path to remove the entry at.
         */
