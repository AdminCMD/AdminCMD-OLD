...
public class ExFileConfigurationOptions extends ExMemoryConfigurationOption {
        ...
        /**
         * Gets whether or not the header should be copied from a default
         * source.
         * <p>
         * If this is true, if a default {@link ExFileConfiguration} is passed
         * to
         ...
         * type FileConfiguration, or that config has no header
        ...
        /**
         * Sets whether or not the header should be copied from a default
         * source.
         * <p>
         * If this is true, if a default {@link ExFileConfiguration} is passed
         * to
         ...
         * the generated output of the {@link ExFileConfiguration}. It is not
         * required to include a newline at the end of the header as it will
         * automatically be applied, but you may include one if you wish for
         * extra spacing.
         * <p>
