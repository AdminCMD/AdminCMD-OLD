...
public class MaterialContainer implements Comparable<MaterialContainer>,
         ...
         * @throws EnchantmentConflictException if there is a conflict between
         * an already existed enchantment on the item.
         * @throws CantEnchantItemException if the item can't be enchanted by
         * this enchantment.
         */
         ...
         *
         * @param enchant string containing the enchantment like
         ...
         * @throws IllegalArgumentException if the material can't be colored
         */
