...
public class PlayerManager {
        ...
        /**
         * Set Offline an online player. The player will lost his strong
         * reference, when the gc will be called, the reference will be deleted.
         *
         * @param player player to setOffline
         * @return
         */
