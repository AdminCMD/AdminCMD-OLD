...
public abstract class ACPlayer {
         ...
         *
         * @param presentation a little text to present the player
         */
        ...
        /**
         * @param lastCmd the last Command to set
         */
         ...
         *
         * @throws NullPointerException if last command is not defined
        ...
        /**
         * @param tpRequest the tpRequest to set
         */
         ...
         * @throws InvalidParameterException if the player is offline
         */
