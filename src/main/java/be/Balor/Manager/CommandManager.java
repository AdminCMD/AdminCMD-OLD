...
public class CommandManager implements CommandExecutor {
         ...
         * />
         * First look as a simple bukkit command, then in the alias defined by
         * the user.
         *
         * @param player player that will execute the command.
         */
         ...
         * UnRegister command
         *
         * @param clazz command to unregister
         * @param plugin plugin that want the command to be unregister. It has
         * to be the same that belong to the command.
         */
