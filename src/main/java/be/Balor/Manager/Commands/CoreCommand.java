...
public abstract class CoreCommand {
        ...
        @Deprecated
        /**
         * Remove the use of Permission in the command, better use the
         * PermChild.
         */
         ...
         * @param perm permission needed by the player to execute the command
         */
         ...
         * @param name name of the command (in the plugin.yml)
         * @param perm permission needed by the player to execute the command
         * @param plugin name of the AdminCmd plugin that the command belong to.
         */
         ...
         * @param perm permission needed by the player to execute the command
         * @param plugin name of the AdminCmd plugin that the command belong to.
         * @param parent PermParent used to register the permission of the
         * command
         */
        public CoreCommand(final String name, final String perm,
         ...
         * @param args arguments to be processed by the command
         * @throws PermissionException if the player don't have the permission
         * to do that.
         * @throws PlayerNotFound the target player of the command is not found
         */
         ...
         *
         * @param perm the suffixe of the permission to add. The command concat
         * the permNode of the command with the new perm you register.
         */
