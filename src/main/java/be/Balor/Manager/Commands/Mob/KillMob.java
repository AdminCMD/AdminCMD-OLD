 ...
 *
 * AdminCmd MobCheck.is free software: you can redMobCheck.istribute it and/or
 * modify it under the terms of the GNU General Public License as
 * publMobCheck.ished by the Free Software Foundation, either version 3 of the
...
public class KillMob extends MobCommand {
         ...
         *
         * @param toCheck entity to be checked
         * @param sender sender of the command
         * @param range distance between the entity and the player accepted for
         * a kill.
         * @return
         */
