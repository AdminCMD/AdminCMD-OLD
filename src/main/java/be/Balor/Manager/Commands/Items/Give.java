...
public class Give extends ItemCommand {
         ...
         * @param mat to which material add the enchantments
         * @param startIndex where to start to parse the args
         */
        ...
        /**
         * Parse all argument, check all condition and create the item that will
         * be given to the player
         *
         * @param sender sender of the command
         * @param args arguments of the command
         * @param permNode permission needed by the command
