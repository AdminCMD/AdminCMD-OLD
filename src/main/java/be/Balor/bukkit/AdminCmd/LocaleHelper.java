...
public enum LocaleHelper {
         ...
         *
         * @param sender CommandSender that will get the message
         * @param replace Replacement variables
         */
         ...
         * @param value value to replace the key
         */
         ...
         * Send the locale the the CommandSender
         *
         * @param sender CommandSender that will get the messages
         */
